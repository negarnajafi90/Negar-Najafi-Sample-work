...
<head>
  ...
  <title>Edit Contact - Masterre</title>
...
String ContactID=(String)request.getParameter("ContactID"); //Getting the Agent ID which the user has been choosene

int ID=Integer.parseInt(ContactID);

if( ContactID==null ||ContactID=="" ){ ContactID="0";}

else{ ContactID=(String)request.getParameter("ContactID"); }
...
Contacts EditContact=new Contacts();


EditContact=myRDS.SerchContactsbyID(ID,con);
...
<body>
  <div style='display: flex'>
    ...
    <div id="Right" style="margin-bottom: 100px;"
      class="Rightcolumn marginBody navBarMovable">
      ...
      <div class="HeaderDashboard flexibleContainer" style='margin-top: 14px;'>
        ...
        <label class="DealsHeader flexible">Edit Contact</label>

      </div>

      <form id="NewUser" name="NewUser" method="post" action="../EditContact" enctype="multipart" target="hiddenFrame"
        ...
        <div id="myModalSaveClose" class="modal">
          ...
          <div class="modal-content">
            ...
            <div class="popUpContainer">
              ...
              <button class="submitButton" type="submit" id="SaveClose" name="SaveClose">Yes</button>
            </div>
          </div>
        ...
        <div class="flexibleContainer">
          ...
          <div id="LastNameBlock" class="flexible" style="display: none;">
            ...
            <input class="inlineInput" type="text" id="NewLastName" name="NewLastName"  maxlength="45" value="<%=EditContact.LastName%>">
          </div>
        ...
        <div class="flexibleContainer NewSectionMedium">
          ...
          <div class="flexible ">
            ...
            <input class="inlineInput" type="text" id="newClientUnit" name="newClientUnit" value="<%=EditContact.Unit%>" maxlength="10">
        ...
        <div class="flexibleContainer">
          ...
          <div class="flexible ">
            ...
            <input class="inlineInput" type="text" maxlength="30"
              id="newClientCity" name="newClientCity" value="<%=EditContact.City%>">
          ...
          <div class="flexible ">
            ...
            <input class="inlineInput" type="text" maxlength="11"
              id="newClientPostalCode" name="newClientPostalCode" value="<%=EditContact.PostalCode%>">
          ...
          <div class="flexible">
            ...
            <input type="text" class="inlineInput" id="newClientCountry" name="newClientCountry" maxlength="20"
        ...
        <div class="flexibleContainer">
          ...
          <div class="flexible itemLongerPhone">
            ...
            <input class="input inlineInput" type="text" id="Phone" name="Phone" onkeydown="phoneNumberFormatter(this.id)" maxlength="140"
              onchange="phoneNumberFormatter(this.id);" value="<%=EditContact.Phone%>">
          </div>
          ...
          <div class="flexible itemShortPhone">
            ...
            <input class="input inlineInput" type="text" id="ExtraContactInformation" name="ExtraContactInformation" maxlength="20"
              value="<%=EditContact.ExtraContactNumber%>" onkeydown="phoneNumberFormatter(this.id)"
          ...
          <div id="ClerkInformation" class="NewSectionSmall" style="display:none">
            ...
            <div class="flexibleContainer ">
              ...
              <div class="flexible itemLongerAssistantName">
                ...
                <input class="input inlineInput" type="text" id="ClerkFullName" name="ClerkFullName" maxlength="60"
                  value="<%=EditContact.ClerkName%>">
              </div>
              ...
              <div class="flexible ">
                ...
                <input onblur="emailCorrect(this.id)" class="input inlineInput" type="text" id="ClerkEmail" maxlength="50"
                  name="ClerkEmail" value="<%=EditContact.ClerkEmail%>">
              </div>
        ...
        <div class="Footer FooterButton">
          ...
          <div class="FooterButtonSpan">
            ...
            <span id="PurchaserLawyernext1" class="buttonDiscard floatDataLefttSide">
              ...
              <a href="Contacts.jsp"><button id="PurchaserLawyerBack" type="button" class="buttonBlue" onclick="">Cancel</button></a> 
              </span>
            </span>
            ...
            <span class="secondSpan">
              ...
              <span class="savespan" id="savespan">
                ...
                <button class="buttonSaveOne" type="button" id="Save" onclick="">Save</button>

                <button class="buttonSaveTwo" onclick="openWindowNewContact(event)" type="button">&nbsp;</button>

              </span>

              <button class="buttonBlue" type="submit" id="SaveandNew" name="SaveandNew" style="width: 85px;" onclick="">Save and new</button>
  ...
  <script>
    ...
    saveandNew.onclick = function (event) {
      if (validate()) {
        document.getElementById('ErrorEmpty1').style.display = 'none';
        document.getElementById('NewUser').target = '';
        // document.getElementById('NewUser').action = '../EditContact';
  ...
  <script>
    var UserType = "<%=EditContact.Type%>";

    document.getElementById('UserType').value = UserType.replace(/\s/g, '');

    UserValue = "<%=EditContact.Type%>";



    if (UserValue == 'LawFirm') {
      ...
      if(document.getElementById('ClerkFullName').value){
          ...
          document.getElementById('ClerkInformation').style.display = '';
        }

    } else if (UserValue == 'Brokerage') {
    ...
    } else if (UserValue == 'Client') {


      var clientType = "<%=EditContact.PartyType%>";

      document.getElementById('ClientType').value = clientType.replace(/\s/g, '');
