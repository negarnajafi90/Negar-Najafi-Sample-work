...
String InvData = "";
if(dealtype.equals("Appraisal")){
    InvData = myRDS.GetTRSOtherData(brokerid,dealid,con);
}else if(dealtype.equals("Referral")){
    InvData = myRDS.GetTRSReferralData(brokerid,dealid,con);
}else{
                    ...
                    <div class="flexibleContainer">
                        <% 
                                ...
                                if(dealtype.equals("Appraisal")){
                                    ...
                                    if(partyType.equals("Client")){
                                    	
                                        //System.out.println("i"+"   "+i);
                                        
                                       // System.out.println(oneParty.get("Email"));
						%>

                        <div class="flexible flexibleContainer">
                            <div class="flexible check">
                                <label class="container flexible">
                                    <input class="inlineInput" type="checkbox" id="Addressee<%=i%>" name="Addressee<%=i%>">
                            ...
                            <div class="flexible names">
                                ...
                                <input class="ref" id="emailValueAddressee<%=i%>" name="emailValueAddressee<%=i%>" value='<%=oneParty.get("Email")%>' readonly="">
                            </div>
                        </div>

                        <% } //End of if(partyType.equals("Client"))
                        	
                                    } //End of if(dealtype.equals("Appraisal"))
                                
                         else{ 
                        	
                        	if(partyType.equals("Source")){     
                            ...
                            <div class="flexible flexibleContainer">
                                ...
                                <div class="flexible names">
                                    <label class="heavyfont" for="Addressee0">Referral Recipient</label>
                                    <label for="Addressee0"><%=oneParty.get("Name")%></label>
                                    <input class="ref" id="emailValueAddressee<%=i%>" name="emailValueAddressee<%=i%>" value='<%=oneParty.get("Email")%>' readonly="">
                                </div>
                            </div>
                         ...
                         <% } //End of if(partyType.equals("Source"))
                ...
                <div class="optional">
                    ...
                    <div id="optionalDIV" class="remove">
                        <div class="flexibleContainer">
                            ...
                            <% }}else{if(partyType.equals("Client")){%>
                                <div class="flexible flexibleContainer">
                                    <div class="flexible check">
                                        <label class="container flexible">
                                            <input class="inlineInput" type="checkbox" id="OptionalAddressee<%=i%>" name="OptionalAddressee<%=i%>">
                                    ...
                                    <div class="flexible names">
                                        <label class="heavyfont" for="Addressee0">Client</label>
                                        <label for="Addressee0"><%=oneParty.get("Name")%></label>
                                        <input class="ref" id="OptionalemailValueAddressee<%=i%>" name="OptionalemailValueAddressee<%=i%>" value='<%=oneParty.get("Email")%>' readonly="">
                                    </div>
                                </div>
